            ...
            <div className="min-h-screen flex items-center justify-center p-6">
                <div className="grid md:grid-cols-2 items-center gap-16 max-w-6xl w-full fade-in">
                    <div className="hidden md:block text-left content-wrapper">
                        ...
                        <p className="text-lg text-text-secondary">Sign in to access exclusive reviews, comparisons, and
                            news analysis.</p>
                    </div>
                    ...
                    <div className="form-wrapper p-8 rounded-2xl w-full max-w-md md:max-w-full">
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <a href="#" className="text-sm font-semibold text-primary hover:underline">Forgot
                                    password?</a>
                            </div>
                            ...
                            <p className="text-center text-sm text-text-secondary pt-4">
                                ...
                                {/* Replace <a> with <Link> */}
                                <Link to="/register"
                                      className="font-bold text-primary hover:underline ml-1 inline-flex items-center">Create
                                    one<UserPlus className="w-4 h-4 ml-1"/></Link>
                            </p>
                        </form>
                    </div>
                </div>
